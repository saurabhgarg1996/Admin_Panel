<?php
	...
	function aGetsubCatByIds($category_id,$sub_category_id)
	{
        comment_message_log('Start of Function : '. __FUNCTION__);
        ...
        */
        ...
        //! Query
        $sQuery = "SELECT * FROM `sub_category` WHERE md5(category_id) = '$category_id' and md5(sub_category_id) = '$sub_category_id' ";

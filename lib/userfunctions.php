<?php
	function  insertintousers($full_name, $pass,$email_id,$isActive,$user_address,$dob,$gender,$created_at)
	{
		 //! Message Loggin
        ...
        //! Query
        $sQuery = "INSERT INTO `user` (`user_id`,`full_name`, `pass`,`email_id` ,`isActive`,`user_address`,`created_at`,`dob`,`gender`) VALUES (NULL, '$full_name','$pass','$email_id','$isActive','$user_address', '$created_at','$dob','$gender');";
